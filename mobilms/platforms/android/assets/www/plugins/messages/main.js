...
define(requires, function (messagesTpl, recentTpl, conversationTpl, contactTpl, contactsTpl, searchTpl, bubblesTpl) {
    ...
    var plugin = {
        ...
        pollingInterval: 1800000, // 30 minutos
        ...
        showConversation: function(userId) {
            ...
            if (user) {
                ...
                if (user.get("profileimageurl")) {
					...
					userPicture = MM.util.getMoodleFilePath( user.get("profileimageurl") );
                }
            }
            ...
            MM.plugins.messages._getRecentMessages(
                ...
                function(messagesReceived) {
					try{
						...
						// $(".recent-conversation .touch-row").on("click", function(){
							// alert($(this).attr("href"));
							// var msglink = $(this).attr("href"); 
							// msglink = msglink.replace("#messages/conversation/", "");
							// MM.plugins.messages.showConversation(msglink);
						// });
					}catch(e){
						if(e){
						}
        ...
        _renderConversation: function(userId, userName, userPicture, messagesReceived, messagesSent) {
			...
			//$("#btnMessageSend").on( "click", function(e) {
                e.preventDefault();
			...
			function keyboardShowHandler(e){
				setTimeout(function() {
					conversationArea.css('height', ($(document).innerHeight()/2) - 60 );
				}, 0);
			}
                        ...
                        MM.plugins.messages._getRecentMessages(
                            ...
                            function(messagesSent) {
                                ...
                                if (messages.length > 0) {
									...
									//@start
									var navigator_language = "pt-BR";
									var previousDate = d.toLocaleDateString(navigator_language, {year: 'numeric', month:'long', day: '2-digit'});
