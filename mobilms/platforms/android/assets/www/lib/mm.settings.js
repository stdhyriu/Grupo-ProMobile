...
'		</tr>                '+    
	'	<tr class="section-name">'+   
	'		<th >Backbone and Underscore</th></tr>'+   
	'		<tr><td >'+   
...
'</table>';
    ...
    showDevice: function() {
		...
		info += '<div class="centered"><a onclick="javascript:window.location.href=\'mailto:'+ MM.config.reportbugmail +'?subject=MobiLMS-Bug\'"><button>' + MM.lang.s("email") + '</button></a></div>';		
		//info += '<div class="centered"><a onclick="javascript:window.location.href=\"mailto:' + MM.config.current_site.username +'?subject=DeviceInfo&body=' + mailBody + '\""><button>' + MM.lang.s("email") + '</button></a></div>';		
    ...
    showReportbug: function() {
		...
		info += '<div class="centered"><a onclick="javascript:window.location.href=\'mailto:'+ MM.config.reportbugmail +'?subject=MobiLMS-Bug\'"><button>' + MM.lang.s("email") + '</button></a></div>';
		info += "<br /><br /><br />";				
		//emailinfo = 'mailto:' + MM.config.reportbugmail +'?subject=[[Mobile App Bug]]&body=' + mailInfo + '';
		//info += '<div class="centered"><a onclick="javascript:window.location.href=\''+emailinfo+'\'" target="_blank"><button>' + MM.lang.s("email") + '</button></a></div>';
       // info += "<br /><br /><br />";
    ...
    showAbout: function() {
        $.getJSON("about.json", function(data) {
            ...
            var info = "\
                ...
                <table class='about'>\
                <thead>\
                <tr><th>MobiLMS - Extensão no Moodle Mobile</th></tr>\
                </thead>\
                <tbody>\
